      ...
      <div class="col-md-4">
        <div class="card shadow-sm">
          <div class="card-body" style="background-color: #D4BFBB">
            <h3 class="card-title mb-4 text-center" style="color: #4B3D3D; font-family: 'Bold', sans-serif;">Create an Account</h3>
            ...
            <form method="POST" action="/register" enctype="multipart/form-data">
              ...
              <div style="display: flex; gap: 5px;">
                <div class="mb-3">
                  ...
                  <input type="first_name" style="background-color: rgba(255, 255, 255, 0.25); color: #4B3D3D; font-family: 'Regular', sans-serif;" class="form-control" id="first_name" name="first_name" value="{{ old('first_name') }}" required>
                </div>
                <div class="mb-3">
                  <label for="last_name" class="form-label" style="color: #4B3D3D; font-family: 'Bold', sans-serif;">Last Name</label>
                  <input type="last_name" style="background-color: rgba(255, 255, 255, 0.25); color: #4B3D3D; font-family: 'Regular', sans-serif;" class="form-control" id="last_name" name="last_name" value="{{ old('last_name') }}" required>
                </div>
              </div>
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label for="icon" class="form-label" style="color: #4B3D3D; font-family: 'Bold', sans-serif;">Profile Picture</label>
              ...
              <div class="mb-2 d-flex justify-content-between align-items-center" style="gap: 5px;">
                  <button type="submit" class="btn" style="background-color: #F9EAE6; border-color: #98FB98; border-width: 3px; color: #4B3D3D; font-family: 'Regular', sans-serif;">Create Account</button><a href="/login" class="btn" style="background-color: #F9EAE6; border-color: #ff5733; border-width: 3px; color: #4B3D3D; font-family: 'Regular', sans-serif;">Cancel</a>
              </div>
            </form>
