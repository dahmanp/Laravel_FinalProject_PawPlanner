          ...
          <div class="card-body" style="background-color: #D4BFBB">
            ...
            <form method="POST" action="/createpet" enctype="multipart/form-data">
              ...
              <div class="mb-2 d-flex justify-content-between align-items-center" style="gap: 5px;">
                  <button type="submit" class="btn btn-primary w-40" style="color: #4B3D3D; font-family: 'Regular', sans-serif;">Create Pet</button><a href="/dashboard" class="btn btn-primary w-40" style="color: #4B3D3D; font-family: 'Regular', sans-serif;">Cancel</a>
              </div>
